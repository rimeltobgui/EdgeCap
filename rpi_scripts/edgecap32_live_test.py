...
# Load CLIP model (ViT-B-32 is relatively light)
...
model.mapper.load_state_dict(torch.load("vit-b-32-mapper_trained_25epochs.pth", map_location=device))
...
# Capture and caption one image from camera
